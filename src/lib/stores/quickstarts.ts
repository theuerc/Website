...
const quickstartItems = readable([
  ...
  mapQuickstart("Deno", "introduction/getting-started/quickstart/deno", false),
  mapQuickstart(
    "Docker Compose",
  ...
  mapQuickstart("Perl", "introduction/getting-started/quickstart/perl", false),
  mapQuickstart(
    "PHP Drupal",
  ...
  mapQuickstart("Wasp", "introduction/getting-started/quickstart/wasp", false),
  mapQuickstart(
    "Wordpress",
