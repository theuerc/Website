<script lang="ts">
  ...
  import OtherCdeBuilders from "$lib/components/svgs/customers/otherCDEBuilders.svelte";
</script>
    ...
    >
      <div class="mt-x-small md:my-0 flex-wrap">
        <div class="text-large">
          ...
          <p class="mt-6 md:mt-8 max-w-lg">
            What big tech companies are trying to build internally, Gitpod’s
            developer platform is bringing to the rest of the world. Read more
            about the benefits of CDEs for organizations.
          </p>
        </div>
        <div class="flex items-start -ml-6 mt-4 md:mt-8 mb-8 md:mb-0">
          <OtherCdeBuilders />
        </div>
