...
<section
  class="max-w-3xl mt-medium lg:mt-xx-large mx-auto space-y-small lg:space-y-x-large md:space-y-[100px]"
>
  <article>
    ...
    <br />
    <p>
      But it isn’t. Devs constantly struggle with larger codebases, cluttered
      dependencies, security policies and unnecessary friction in their
      workflows. We want to empower developers and empower them to code.
    </p>
  </article>
  <article>
    <h2 class="h4 md:!mb-xx-small">
  ...
  <article>
    ...
    <p>
      ...
      advisors of the world. In 2021, we announced a $13m funding round led by
      Steve Herrod, Managing Director of General Catalyst.
    </p>
    <br />
    <p>
    ...
    <p>
      ...
      product, our company and our brand: no hurdles, no BS, no unnecessary
      extra steps.
    </p>
    <br />
    ...
    <p>
      🧡 We celebrate diversity and strive for an equal, inclusive, empathetic
      and welcoming environment. We are currently not as diverse as we would
      like to be, but are actively working to build a more diverse and inclusive
      team.
    </p>
  </article>
</section>
