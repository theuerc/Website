...
We've been working on our documentation which now includes a revamped [installation guide](https://www.gitpod.io/docs/self-hosted/latest/installing-gitpod) and a more detailed explanation of [requirements](https://www.gitpod.io/docs/self-hosted/latest/cluster-requirements) Gitpod has on the cluster it runs on, as well as which [components](https://www.gitpod.io/docs/self-hosted/latest/required-components) are needed to support it.
